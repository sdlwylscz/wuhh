# -*- coding: utf-8 -*-
"""
Created on Mon Nov 14 20:27:00 2016
...
all_url = 'http://www.mzitu.com/79545/3'  ##开始的URL地址
start_html = requests.get(all_url,  headers=headers)

html = re.findall('<div class="main-image">(*?)</a>',content1)
print(html)
html2 = re.findall('<img src="(*?) alt',html)

os.chdir("import requests
...
with open("meinv") as f:
    f.read = urllib2.urlopen(html2)
